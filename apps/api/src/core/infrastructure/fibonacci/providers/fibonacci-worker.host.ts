...
import { Observable, filter, firstValueFrom, fromEvent, map, tap } from 'rxjs';
  ...
  implements OnApplicationBootstrap, OnApplicationShutdown
{
  ...
  onApplicationBootstrap() {
    this.worker = new Worker(join(__dirname, '../workers/fibonacci.worker.js'));
